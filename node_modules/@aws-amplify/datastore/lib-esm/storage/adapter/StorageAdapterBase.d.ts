...
import { InternalSchema, ModelInstanceMetadata, ModelPredicate, NamespaceResolver, OpType, PaginationInput, PersistentModel, PersistentModelConstructor, PredicatesGroup, QueryOne, RelationType } from '../../types';
...
export declare abstract class StorageAdapterBase implements Adapter {
    ...
    protected abstract getHasOneChild<T extends PersistentModel>(model: T, srcModel: string, namespace: NAMESPACES, rel: RelationType): Promise<T | undefined>;
    /**
     ...
     */
    protected abstract getHasOneChildLegacy<T extends PersistentModel>(model: T, srcModel: string, namespace: NAMESPACES, rel: RelationType): Promise<T | undefined>;
    protected abstract getHasManyChildren<T extends PersistentModel>(storeName: string, index: string, keyValues: string[]): Promise<T[] | undefined>;
    /**
     ...
     * @param deleteQueue
     */
    protected deleteTraverse<T extends PersistentModel>(relations: RelationType[], models: T[], srcModel: string, namespace: NAMESPACES, deleteQueue: {
        storeName: string;
        items: T[];
    }[]): Promise<void>;
}
